jQuery(document).ready(function($) {    
    ...
    */
    $('.relatedwrap').each(function(){
        ...
        NewId = $('#'+Id+" .storerelated").lightSlider({
            item:3,
            pager:false,
            loop:true,
            speed:600,
            ...
            slideMargin:20,
            onSliderLoad: function() {
                $('.storerelated').removeClass('cS-hidden');
            },
            responsive : [
                {
                    breakpoint:800,
    ...
    */
    $('.upsellswrap').each(function(){
        
        var Id = $(this).attr('id');
        var NewId = Id; 

        NewId = $('#'+Id+" .storeupsells").lightSlider({
            item:3,
            pager:false,
            loop:true,
            speed:600,
            ...
            slideMargin:20,
            onSliderLoad: function() {
                $('.storeupsells').removeClass('cS-hidden');
            },
            responsive : [
                {
                    breakpoint:800,
