    ...
    switch ($sparklestore_widgets_field_type) {
        ...
        case 'number' :
            ...
            <p>
                ...
                <input name="<?php echo $instance->get_field_name($sparklestore_widgets_name); ?>" type="number" step="4" min="4" id="<?php echo $instance->get_field_id($sparklestore_widgets_name); ?>" value="<?php echo $sparklestore_field_value; ?>" class="widefat" />
