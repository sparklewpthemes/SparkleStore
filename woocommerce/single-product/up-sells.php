...
if ( $products->have_posts() ) : ?>
	...
	<div class="up-sells upsells products upsellswrap" id="sparkleupsells">		

		<div class="blocktitlewrap">                        
		    <div class="blocktitle">
		        <h2><?php _e( 'You may also like&hellip;', 'sparklestore' ) ?></h2>
		    </div>
		...
		<ul class="products storeupsells cS-hidden">
